    ...
    <div class="modal-container">
      <div class="modal-header">
        <h2 class="modal-title">
          <span class="modal-title-accent">/</span> Политика конфиденциальности
          <span class="modal-title-accent">/</span>
        </h2>
      </div>

      <div class="modal-content">
        <div class="policy-date">Дата последнего обновления: 1 января 2024 г.</div>

        <div class="policy-section">
          <h3 class="policy-section-title">1. Общие положения</h3>
          <p class="policy-text">
            ...
            персональных данных, предпринимаемые ООО "Автодетейлинг" (далее – Оператор).
          </p>
          <p class="policy-text">
          ...
          <p class="policy-text">
            ...
            веб-сайта https://detailstudio.ru.
          </p>
        </div>

        <div class="policy-section">
          <h3 class="policy-section-title">2. Основные понятия, используемые в Политике</h3>
          <p class="policy-text">
          ...
          <p class="policy-text">
            ...
            определенному или определяемому Пользователю веб-сайта https://detailstudio.ru.
          </p>
          <p class="policy-text">
            2.9. Пользователь – любой посетитель веб-сайта https://detailstudio.ru.
          </p>
          <p class="policy-text">
        ...
        <div class="policy-section">
          ...
          <p class="policy-text">3.1. Фамилия, имя, отчество;</p>
          <p class="policy-text">3.2. Номер телефона;</p>
          <p class="policy-text">3.3. Адрес электронной почты;</p>
          <p class="policy-text">
        ...
        <div class="policy-section">
          <h3 class="policy-section-title">4. Цели обработки персональных данных</h3>
          <p class="policy-text">
          ...
          <p class="policy-text">
            ...
            электронной почты info@detailstudio.ru с пометкой «Отказ от уведомлений о новых
        ...
        <div class="policy-section">
          <h3 class="policy-section-title">5. Правовые основания обработки персональных данных</h3>
          <p class="policy-text">
            ...
            расположенные на сайте https://detailstudio.ru. Заполняя соответствующие формы и/или
        ...
        <div class="policy-section">
          ...
          <p class="policy-text">
            ...
            меры, исключающие доступ к персональным данным неустановленных лиц.
          </p>
          <p class="policy-text">
          ...
          <p class="policy-text">
            ...
            электронной почты Оператора info@detailstudio.ru с пометкой «Актуализация персональных
            данных».
          </p>
          <p class="policy-text">
            ...
            info@detailstudio.ru с пометкой «Отзыв согласия на обработку персональных данных».
          </p>
        </div>
        ...
        <div class="policy-company">
          ...
          <p>
            603105, Нижегородская область, г. Нижний Новгород, ул. Кузнечихинская, д. 37, кв. 19
          </p>
